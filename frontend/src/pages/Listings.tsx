...
const MOCK_LISTINGS = [
  ...
  {
    id: 201,
    title: '3BR Apartment for Rent in Achrafieh',
    listing_type: 'rent',
  ...
  {
    id: 202,
    title: '2BR Apartment for Rent in Kaslik',
    listing_type: 'rent',
    property_type: 'Apartment',
    city: 'Jounieh',
    area: 'Kaslik',
  ...
  {
    id: 203,
    title: '2BR Apartment for Rent in Hamra',
    listing_type: 'rent',
    property_type: 'Apartment',
    city: 'Beirut',
    area: 'Hamra',
  ...
  {
    id: 204,
    title: 'Studio for Rent in Mar Mikhael',
    listing_type: 'rent',
  ...
  {
    id: 205,
    title: '3BR Chalet for Rent in Broummana',
    listing_type: 'rent',
    property_type: 'House',
    city: 'Broummana',
    area: 'Metn',
  ...
  {
    id: 206,
    title: '2BR Apartment for Rent in Dbayeh',
    listing_type: 'rent',
    property_type: 'Apartment',
    city: 'Dbayeh',
    area: 'Metn Coast',
  ...
  {
    id: 209,
    title: '5BR Luxury Villa in Rabieh',
    listing_type: 'buy',
    property_type: 'Villa',
    city: 'Rabieh',
    area: 'Metn',
  ...
  },
  {
    ...
    furnishing: 'Semi-Furnished',
    status: 'Available',
    image_url: 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=400&h=300&fit=crop',
  },
  {
    id: 212,
    title: '2BR Apartment in Antelias',
    listing_type: 'buy',
    property_type: 'Apartment',
    city: 'Antelias',
    area: 'Metn',
...
export default function Listings() {
  ...
  const loadListings = async () => {
    setLoading(true);
    // API disabled: Railway DB has 50 rent-only listings, use mock data instead
